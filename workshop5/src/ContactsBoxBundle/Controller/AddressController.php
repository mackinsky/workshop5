...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ContactsBoxBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("ContactsBoxBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ContactsBoxBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ContactsBoxBundle:Address:edit.html.twig")
     */
