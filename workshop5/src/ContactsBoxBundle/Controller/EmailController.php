...
use ContactsBoxBundle\Entity\Email;
use ContactsBoxBundle\Form\EmailType;
...
class EmailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ContactsBoxBundle:Email')->findAll();
     ...
     * @Method("POST")
     * @Template("ContactsBoxBundle:Email:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ContactsBoxBundle:Email')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ContactsBoxBundle:Email:edit.html.twig")
     */
